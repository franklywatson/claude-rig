...
- Lock files record the defaults of the *build* that compiled them, not
  just your `.md` — the committed locks churned when
  `GH_AW_ACTION_FAILURE_ISSUE_EXPIRES_HOURS` flipped 168→0 across gh-aw
  builds (isolated chore commit, 2026-09). If a recompile edits lock lines
  you never authored, suspect compiler-default drift and verify with the
  pinned v0.86.2 before committing.
